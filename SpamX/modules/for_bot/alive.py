...
async def SpamX_(SpamX: Client, message: Message):
    ...
    spamx_reply = "**__SpamX by ll_SABKA_BHAI_KILLER_ll;__** \n\n"
    spamx_reply += "<=======================> \n"
    ...
    spamx_reply += "<=======================> \n\n"
    spamx_reply += "**Source Code:** [GitHub 🐈‍⬛](https://t.me/ll_SABKA_BHAI_KILLER_ll) \n\n"
    spamx_reply += "**© @ll_SABKA_BHAI_KILLER_ll** || Support: @do_dil_ek_jaan143"
